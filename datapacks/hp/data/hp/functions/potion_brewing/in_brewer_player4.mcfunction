...
# Scroll testers
execute as 0-0-13-0-3 at @s positioned ^ ^ ^10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[brewerSelect,selectUp],UUIDMost:20,UUIDLeast:13}
execute as 0-0-13-0-3 at @s positioned ^ ^ ^-10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[brewerSelect,selectDown],UUIDMost:20,UUIDLeast:14}
execute as 0-0-13-0-3 at @s positioned ^10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invLeft\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[brewerSelect,selectLeft],UUIDMost:20,UUIDLeast:15}
execute as 0-0-13-0-3 at @s positioned ^-10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invRight\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[brewerSelect,selectRight],UUIDMost:20,UUIDLeast:16}
