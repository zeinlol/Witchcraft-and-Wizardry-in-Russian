...
replaceitem entity @s[scores={editPage=0}] hotbar.4 minecraft:endermite_spawn_egg{display:{Name:"{\"text\":\"Spawn Маленький Сундук\",\"color\":\"gold\",\"italic\":false}"},EntityTag:{NoAI:1b,Tags:["spawnSmallChest"]},qDetect:1b,altFDetect:1b}
...
replaceitem entity @s[scores={editPage=1}] hotbar.5 minecraft:endermite_spawn_egg{display:{Name:"{\"text\":\"Set Колба\",\"color\":\"gold\",\"italic\":false}"},EntityTag:{NoAI:1b,Tags:["spawnFlask"]},qDetect:1b,altFDetect:1b}
...
# replaceitem entity @s[scores={editPage=4}] hotbar.6 minecraft:endermite_spawn_egg{display:{Name:"{\"text\":\"Set Диадема\",\"color\":\"gold\",\"italic\":false}"},EntityTag:{NoAI:1b,Tags:["spawnDiadem"]},qDetect:1b,altFDetect:1b}
...
execute as @s[tag=hasPressedF,scores={editStick=2},tag=!inInventory] if entity @e[tag=hover,limit=1,tag=creaturePointSpawn,scores={nestType=2}] run tellraw @s ["",{"text":"Nest type set to: Растопырникs","color":"white"}]
execute as @s[tag=hasPressedF,scores={editStick=2},tag=!inInventory] if entity @e[tag=hover,limit=1,tag=creaturePointSpawn,scores={nestType=3}] run tellraw @s ["",{"text":"Nest type set to: Большой Паукs","color":"white"}]
execute as @s[tag=hasPressedF,scores={editStick=2},tag=!inInventory] if entity @e[tag=hover,limit=1,tag=creaturePointSpawn,scores={nestType=4}] run tellraw @s ["",{"text":"Nest type set to: Небольшой Паукs","color":"white"}]
...
execute as @s[tag=hasPressedF,scores={editStick=2},tag=!inInventory] if entity @e[tag=hover,limit=1,tag=creaturePointSpawn,scores={nestType=8}] run tellraw @s ["",{"text":"Nest type set to: Пожиратель Смертиs","color":"white"}]
...
execute as @s[tag=hasPressedF,scores={editStick=2},tag=!inInventory] if entity @e[tag=hover,limit=1,tag=creaturePointSpawn,scores={nestType=16}] run tellraw @s ["",{"text":"Nest type set to: Полтергейстs","color":"white"}]
...
execute at @e[tag=spawnSmallChest] run summon minecraft:armor_stand ~ ~ ~ {Marker:1b,NoGravity:1b,Team:"NPC",CustomName:"{\"text\":\"Маленький Сундукˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈˈ\",\"color\":\"dark_gray\"}",Invulnerable:1b,DisabledSlots:2039583,Invisible:1b,Tags:["chest","smallChest","interactable","glowable","restorable","smallChestBeingSpawned","resettable"],ArmorItems:[{},{},{},{id:"minecraft:wooden_sword",Count:1b,tag:{Unbreakable:1b,Damage:56}}],NoBasePlate:1b}
