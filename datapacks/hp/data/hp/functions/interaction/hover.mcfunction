...
# Vera Verto
execute if entity @s[scores={pickUpTimer=0},tag=!inWingardium,tag=!showMaraudersMap,tag=!inQuestBook,tag=!inSettings,tag=!showSpellSelection,tag=!castAlohomora,tag=!inProperCutScene,tag=!inResetPoint,tag=!cutsceneOverrideActionbar,tag=!invisCape,tag=!omnioculars,tag=!stunnedByMandrake,tag=!earmuffs,tag=play] if entity @e[tag=hover,tag=interactable,tag=veraVerto,limit=1] store success score @s tmp run title @s actionbar  ["",{"text":"!","bold":true,"color":"blue"},{"text":" ","bold":true,"color":"dark_gray"},{"text":"Можно трансфигурировать с помощью заклинания «Фера Верто»"},{"text":" ","bold":true,"color":"dark_gray"},{"text":"!","bold":true,"color":"blue"}]

# Wingardium
execute if entity @s[scores={pickUpTimer=0},tag=!inWingardium,tag=!showMaraudersMap,tag=!inQuestBook,tag=!inSettings,tag=!showSpellSelection,tag=!inInventory,tag=!castAlohomora,tag=!inProperCutScene,tag=!inResetPoint,tag=!cutsceneOverrideActionbar,tag=!invisCape,tag=!stunnedByMandrake,tag=!earmuffs,tag=play] if entity @e[tag=hover,tag=interactable,tag=wingardium,limit=1] store success score @s tmp run title @s actionbar  ["",{"text":"!","bold":true,"color":"dark_purple"},{"text":" ","bold":true,"color":"dark_gray"},{"text":"Можно поднять с помощью заклинания «Вингардиум Левиоса»"},{"text":" ","bold":true,"color":"dark_gray"},{"text":"!","bold":true,"color":"dark_purple"}]
...
execute if entity @s[scores={pickUpTimer=0},tag=inWingardium,tag=hoveringOnWingardiumBox,tag=isLiftingWingardiumBox,tag=play] store success score @s tmp run title @s actionbar ["",{"text":"Нажмите ","color":"dark_purple"},{"text":"⌡","bold":false,"color":"white"},{"text":", чтобы уронить","color":"dark_purple"}]
execute if entity @s[scores={pickUpTimer=0},tag=inWingardium,tag=hoveringOnWingardiumBox,tag=!isLiftingWingardiumBox,tag=hoveringOnWingardiumBoxInSwitch,tag=play] store success score @s tmp run title @s actionbar ["",{"text":"Нажмите ","color":"dark_purple"},{"text":"⌡","bold":false,"color":"white"},{"text":", чтобы вытащить из переключателя","color":"dark_purple"}]
execute if entity @s[scores={pickUpTimer=0},tag=inWingardium,tag=isLiftingWingardiumBox,tag=hoveringWingardiumBoxOverSwitch,tag=play] store success score @s tmp run title @s actionbar ["",{"text":"Нажмите ","color":"dark_purple"},{"text":"⌡","bold":false,"color":"white"},{"text":", чтобы поставить в переключатель","color":"dark_purple"}]

# Bombarda
execute if entity @s[scores={pickUpTimer=0},tag=!inWingardium,tag=!showMaraudersMap,tag=!inQuestBook,tag=!inSettings,tag=!showSpellSelection,tag=!castAlohomora,tag=!inProperCutScene,tag=!inResetPoint,tag=!cutsceneOverrideActionbar,tag=!invisCape,tag=!stunnedByMandrake,tag=!earmuffs,tag=play] if entity @e[tag=hover,tag=interactable,tag=bombarda_blockade,tag=!explodedBlockade,limit=1] store success score @s tmp run title @s actionbar  ["",{"text":"!","bold":true,"color":"gold"},{"text":" ","bold":true,"color":"gold"},{"text":"Можно разрушить с помощью заклинания «Бомбарда Максима»"},{"text":" ","bold":true,"color":"gold"},{"text":"!","bold":true,"color":"gold"}]
...
execute if entity @s[scores={pickUpTimer=0},tag=!inWingardium,tag=!showMaraudersMap,tag=!inQuestBook,tag=!inSettings,tag=!showSpellSelection,tag=!inInventory,tag=!castAlohomora,tag=!inProperCutScene,tag=!inResetPoint,tag=!cutsceneOverrideActionbar,tag=earmuffs,tag=!isHoveringOnMandrake,tag=play] store success score @s tmp run title @s actionbar ["",{"text":"Надеты наушники-заглушки. Чтобы их снять, нажмите Shift."}]

# Replant mandrake
execute if entity @s[scores={pickUpTimer=0},tag=!inWingardium,tag=!showMaraudersMap,tag=!inQuestBook,tag=!inSettings,tag=!showSpellSelection,tag=!inInventory,tag=!castAlohomora,tag=!inProperCutScene,tag=!inResetPoint,tag=!cutsceneOverrideActionbar,tag=earmuffs,tag=isHoveringOnMandrake,tag=play] store success score @s tmp run title @s actionbar ["",{"text":"Нажмите ","color":"gold"},{"text":"⌡","color":"white"},{"text":", чтобы пересадить мандрагору. ","color":"gold"}]
