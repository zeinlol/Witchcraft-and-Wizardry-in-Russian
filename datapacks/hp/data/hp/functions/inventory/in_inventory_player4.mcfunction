...
# Scroll testers
execute at 0-0-c-0-4 positioned ^ ^ ^10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[invSelect,selectUp],UUIDMost:11,UUIDLeast:13}
execute at 0-0-c-0-4 positioned ^ ^ ^-10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[invSelect,selectDown],UUIDMost:11,UUIDLeast:14}
execute at 0-0-c-0-4 positioned ^10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invLeft\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[invSelect,selectLeft],UUIDMost:11,UUIDLeast:15}
execute at 0-0-c-0-4 positioned ^-10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invRight\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[invSelect,selectRight],UUIDMost:11,UUIDLeast:16}
