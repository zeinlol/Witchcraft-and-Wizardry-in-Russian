...
execute as @s[scores={timeSinceSpawn=0}] unless score @s spawnCount matches 0 if score @s maxCreatureCount > @s creatureCount at @s run function hp:creatures/murtlap/nest_summon_murtlap
...
# Count each murtlap belonging to this nest.
