...
execute if score @s selectCurrent < @s convMaxView as 0-0-1-0-5 if entity @s[tag=selected] run scoreboard players add @p[tag=activePlayer,tag=!invInspectItem] settingsScroll 1
