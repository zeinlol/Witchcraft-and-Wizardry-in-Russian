...
execute if score @s selectCurrent matches 2.. as 0-0-1-0-2 if entity @s[tag=selected] run scoreboard players remove @p[tag=activePlayer,tag=!invInspectItem] settingsScroll 1
