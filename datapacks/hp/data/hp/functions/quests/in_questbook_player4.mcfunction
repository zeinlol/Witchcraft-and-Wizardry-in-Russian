...
# Scroll testers
execute as 0-0-d-0-4 at @s positioned ^ ^ ^10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[questSelect,selectUp],UUIDMost:11,UUIDLeast:13}
execute as 0-0-d-0-4 at @s positioned ^ ^ ^-10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[questSelect,selectDown],UUIDMost:11,UUIDLeast:14}
execute as 0-0-d-0-4 at @s positioned ^10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invLeft\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[questSelect,selectLeft],UUIDMost:11,UUIDLeast:15}
execute as 0-0-d-0-4 at @s positioned ^-10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invRight\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[questSelect,selectRight],UUIDMost:11,UUIDLeast:16}
