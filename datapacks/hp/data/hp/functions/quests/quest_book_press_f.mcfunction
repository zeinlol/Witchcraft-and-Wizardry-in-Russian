...
execute as @s[scores={questMenu=1},tag=!preventDoubleExecution,tag=lockTrackedQuest,tag=!noQuests] run title @s subtitle {"text":"Невозможно изменить отслеживаемое задание сейчас","bold":false,"color":"red"}
