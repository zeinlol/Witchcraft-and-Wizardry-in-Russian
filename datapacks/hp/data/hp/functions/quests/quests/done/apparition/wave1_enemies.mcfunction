...
execute positioned 9072 101 140 run function hp:creatures/death_eater/summon_death_eater
...
execute positioned 9065 91 105 run function hp:creatures/death_eater/summon_death_eater
