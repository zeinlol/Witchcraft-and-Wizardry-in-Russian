execute positioned 4978 121 10003 run function hp:creatures/dark_spirit/summon_dark_spirit
# execute positioned 4988 141 9996 run function hp:creatures/death_eater/summon_death_eater
execute positioned 4990 121 9981 run function hp:creatures/dark_spirit/summon_dark_spirit
execute positioned 5008 141 9983 run function hp:creatures/death_eater/summon_death_eater
# execute positioned 5009 121 9995 run function hp:creatures/dark_spirit/summon_dark_spirit
execute positioned 5019 121 9998 run function hp:creatures/armor_suit/summon_armor_suit
...
# execute positioned 5017 121 10008 run function hp:creatures/dark_spirit/summon_dark_spirit
execute positioned 5025 141 10011 run function hp:creatures/death_eater/summon_death_eater
execute positioned 4971 121 10012 run function hp:creatures/armor_suit/summon_armor_suit
# execute positioned 5021 141 10019 run function hp:creatures/death_eater/summon_death_eater
execute positioned 4990 141 9987 run function hp:creatures/death_eater/summon_death_eater
# execute positioned 4982 141 10002 run function hp:creatures/death_eater/summon_death_eater
execute positioned 5002 121 10012 run function hp:creatures/armor_suit/summon_armor_suit
...
execute as @e[tag=deathEaterCreatureIsBeingSummoned] store result entity @s ArmorItems[3].tag.waveID int 1 run scoreboard players set @s waveID 5
...
execute as @e[tag=armorSuitCreatureIsBeingSpawned] store result entity @s ArmorItems[3].tag.questID int 1 run scoreboard players set @s questID 35
execute as @e[tag=armorSuitCreatureIsBeingSpawned] store result entity @s ArmorItems[3].tag.questSession int 1 run scoreboard players operation @s questSession = azkabanSpellChallengeID global
execute as @e[tag=armorSuitCreatureIsBeingSpawned] store result entity @s ArmorItems[3].tag.waveID int 1 run scoreboard players set @s waveID 5
