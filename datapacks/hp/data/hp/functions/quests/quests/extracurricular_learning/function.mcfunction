...
execute as @s[tag=use] as @e[tag=convOption] if score @s con = @p[tag=activePlayer] questConvOffset run data merge entity @s {CustomName:"{\"text\":\"±ˈˈ Флитвик сказал, ты можешь меня чему-то обучить\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
