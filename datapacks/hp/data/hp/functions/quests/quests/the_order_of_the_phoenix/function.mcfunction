...
execute as @s[tag=use] as @e[tag=convOption] if score @s con = @p[tag=activePlayer] questConvOffset run data merge entity @s {CustomName:"{\"text\":\"±ˈˈ (Рассказать про Пожирателей смерти)\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
...
execute as @s[tag=use] as @e[tag=convOption] if score @s con = @p[tag=activePlayer] questConvOffset run data merge entity @s {CustomName:"{\"text\":\"±ˈˈ Я здесь по поводу Ордена Феникса\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
