...
execute as @s[scores={questState=11,playerID=1},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p1Quests matches 0 run bossbar set minecraft:player1quest name ["",{"text":"Уничтожьте противников (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" из 8)","color":"gold"}]
execute as @s[scores={questState=11,playerID=2},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p2Quests matches 0 run bossbar set minecraft:player2quest name ["",{"text":"Уничтожьте противников (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" из 8)","color":"gold"}]
execute as @s[scores={questState=11,playerID=3},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p3Quests matches 0 run bossbar set minecraft:player3quest name ["",{"text":"Уничтожьте противников (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" из 8)","color":"gold"}]
execute as @s[scores={questState=11,playerID=4},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p4Quests matches 0 run bossbar set minecraft:player4quest name ["",{"text":"Уничтожьте противников (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" из 8)","color":"gold"}]
...
execute as @s[scores={questState=12,playerID=1},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p1Quests matches 0 run bossbar set minecraft:player1quest name ["",{"text":"Уничтожьте противников (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" из 10)","color":"gold"}]
execute as @s[scores={questState=12,playerID=2},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p2Quests matches 0 run bossbar set minecraft:player2quest name ["",{"text":"Уничтожьте противников (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" из 10)","color":"gold"}]
execute as @s[scores={questState=12,playerID=3},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p3Quests matches 0 run bossbar set minecraft:player3quest name ["",{"text":"Уничтожьте противников (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" из 10)","color":"gold"}]
execute as @s[scores={questState=12,playerID=4},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p4Quests matches 0 run bossbar set minecraft:player4quest name ["",{"text":"Уничтожьте противников (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" из 10)","color":"gold"}]
...
execute as @e[tag=creature,scores={waveID=4,questID=22}] run scoreboard players remove @p[tag=activePlayer] tmp 1
execute as @s[scores={questState=13,playerID=1},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p1Quests matches 0 run bossbar set minecraft:player1quest name ["",{"text":"Уничтожьте противников (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" из 12)","color":"gold"}]
execute as @s[scores={questState=13,playerID=2},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p2Quests matches 0 run bossbar set minecraft:player2quest name ["",{"text":"Уничтожьте противников (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" из 12)","color":"gold"}]
execute as @s[scores={questState=13,playerID=3},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p3Quests matches 0 run bossbar set minecraft:player3quest name ["",{"text":"Уничтожьте противников (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" из 12)","color":"gold"}]
execute as @s[scores={questState=13,playerID=4},tag=isTrackedQuest] if score apparitionDeathEaterAttackTimer p4Quests matches 0 run bossbar set minecraft:player4quest name ["",{"text":"Уничтожьте противников (","color":"gold"},{"score":{"name":"@s","objective":"tmp"},"color":"gold"},{"text":" из 12)","color":"gold"}]
