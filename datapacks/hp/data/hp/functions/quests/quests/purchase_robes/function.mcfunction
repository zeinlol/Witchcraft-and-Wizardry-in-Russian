...
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=2,playerID=1,conv=28},tag=isTrackedQuest] run bossbar set minecraft:player1quest name ["",{"text":"Купите школьную мантию","color":"gold"}]
...
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=2,playerID=2,conv=28},tag=isTrackedQuest] run bossbar set minecraft:player2quest name ["",{"text":"Купите школьную мантию","color":"gold"}]
...
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=2,playerID=3,conv=28},tag=isTrackedQuest] run bossbar set minecraft:player3quest name ["",{"text":"Купите школьную мантию","color":"gold"}]
...
execute as @s[tag=inConversation,tag=buy,tag=inInventory,scores={questState=2,playerID=4,conv=28},tag=isTrackedQuest] run bossbar set minecraft:player4quest name ["",{"text":"Купите школьную мантию","color":"gold"}]
