...
execute as @s[tag=newState,scores={playerID=1}] run bossbar set minecraft:player1quest name {"text":"Какой-то золотой череп. Кажется, кто-то пытался избавиться от него","bold":false,"color":"gold"}
execute as @s[tag=newState,scores={playerID=2}] run bossbar set minecraft:player2quest name {"text":"Какой-то золотой череп. Кажется, кто-то пытался избавиться от него","bold":false,"color":"gold"}
execute as @s[tag=newState,scores={playerID=3}] run bossbar set minecraft:player3quest name {"text":"Какой-то золотой череп. Кажется, кто-то пытался избавиться от него","bold":false,"color":"gold"}
execute as @s[tag=newState,scores={playerID=4}] run bossbar set minecraft:player4quest name {"text":"Какой-то золотой череп. Кажется, кто-то пытался избавиться от него","bold":false,"color":"gold"}
...
execute as @s[tag=use] as @e[tag=convOption] if score @s con = @p[tag=activePlayer] questConvOffset run data merge entity @s {CustomName:"{\"text\":\"±ˈˈ Вам что-то известно про этот череп?\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
