...
execute as @s[tag=!softExitMap,tag=!invInspectItem,tag=!preventDoubleExecution,tag=selectedDestinationLocked,scores={convState=1..}] run title @s subtitle {"text":"Вы ещё не открыли это место!","bold":false,"color":"red"}
# Start state
