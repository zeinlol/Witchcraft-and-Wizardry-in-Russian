...
# Scroll testers
execute as 0-0-a-0-1 at @s[tag=!softExitMap] positioned ^ ^ ^10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[mapSelect,selectUp],UUIDMost:11,UUIDLeast:1}
execute as 0-0-a-0-1 at @s[tag=!softExitMap] positioned ^ ^ ^-10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[mapSelect,selectDown],UUIDMost:11,UUIDLeast:2}
execute as 0-0-a-0-1 at @s[tag=!softExitMap] positioned ^10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[mapSelect,selectLeft],UUIDMost:11,UUIDLeast:3}
execute as 0-0-a-0-1 at @s[tag=!softExitMap] positioned ^-10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"invDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[mapSelect,selectRight],UUIDMost:11,UUIDLeast:4}
