...
# Scroll testers
execute as 0-0-11-0-3 at @s[tag=!softExitConv,tag=!inInventory] positioned ^ ^ ^10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"pensiveUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[pensiveSelect,selectUp],UUIDMost:18,UUIDLeast:9}
execute as 0-0-11-0-3 at @s[tag=!softExitConv,tag=!inInventory] positioned ^ ^ ^-10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"pensiveDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[pensiveSelect,selectDown],UUIDMost:18,UUIDLeast:10}
execute as 0-0-11-0-3 at @s[tag=!softExitConv,tag=!inInventory] positioned ^10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"pensiveUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[pensiveSelect,selectLeft],UUIDMost:18,UUIDLeast:11}
execute as 0-0-11-0-3 at @s[tag=!softExitConv,tag=!inInventory] positioned ^-10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"pensiveDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[pensiveSelect,selectRight],UUIDMost:18,UUIDLeast:12}
