...
execute if entity @s[scores={fastTravelID=18}] run title @s subtitle {"text":"Лодочный сарай","bold":true,"color":"gold"}
execute if entity @s[scores={fastTravelID=19}] run title @s subtitle {"text":"Хижина Хагрида","bold":true,"color":"gold"}
execute if entity @s[scores={fastTravelID=20}] run title @s subtitle {"text":"Ворота Хогвартса","bold":true,"color":"gold"}
execute if entity @s[scores={fastTravelID=21}] run title @s subtitle {"text":"Запретный лес","bold":true,"color":"gold"}
execute if entity @s[scores={fastTravelID=22}] run title @s subtitle {"text":"Паучье логово","bold":true,"color":"gold"}
execute if entity @s[scores={fastTravelID=23}] run title @s subtitle {"text":"Квиддичный стадион","bold":true,"color":"gold"}
...
execute if entity @s[scores={fastTravelID=28}] run title @s subtitle {"text":"Тренировочное поле","bold":true,"color":"gold"}
...
execute if entity @s[scores={fastTravelID=38}] run title @s subtitle {"text":"Болото жаб","bold":true,"color":"gold"}
execute if entity @s[scores={fastTravelID=39}] run title @s subtitle {"text":"Канализация","bold":true,"color":"gold"}
...
execute if entity @s[scores={fastTravelID=48}] run title @s subtitle {"text":"Платформа номер девять и три четверти","bold":true,"color":"gold"}
...
execute if entity @s[scores={fastTravelID=52}] run title @s subtitle {"text":"«У Олливандера»","bold":true,"color":"gold"}
execute if entity @s[scores={fastTravelID=53}] run title @s subtitle {"text":"Магазин мадам Малкин","bold":true,"color":"gold"}
...
execute if entity @s[scores={fastTravelID=56}] run title @s subtitle {"text":"Министерство магии","bold":true,"color":"gold"}
...
execute if entity @s[scores={fastTravelID=61}] run title @s subtitle {"text":"Станция «Хогсмид»","bold":true,"color":"gold"}
...
execute if entity @s[scores={fastTravelID=70}] run title @s subtitle {"text":"Подземный ход «Сладкого королевства»","bold":true,"color":"gold"}
execute if entity @s[scores={fastTravelID=71}] run title @s subtitle {"text":"Подземный ход Гремучей ивы","bold":true,"color":"gold"}
execute if entity @s[scores={fastTravelID=72}] run title @s subtitle {"text":"Выручай-комната","bold":true,"color":"gold"}

execute if entity @s[scores={fastTravelID=73}] run title @s subtitle {"text":"Кабинет директора","bold":true,"color":"gold"}
execute if entity @s[scores={fastTravelID=74}] run title @s subtitle {"text":"Азкабан","bold":true,"color":"gold"}
execute if entity @s[scores={fastTravelID=75}] run title @s subtitle {"text":"Площадь Гриммо, 12","bold":true,"color":"gold"}

execute if entity @s[scores={fastTravelID=76}] run title @s subtitle {"text":"Транспортные пути Гринготса","bold":true,"color":"gold"}

scoreboard players set @s fastTravelID 0