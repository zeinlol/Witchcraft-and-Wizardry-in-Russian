...
# In Conversation
execute as 0-0-e-0-1 at @s[tag=!softExitConv,tag=!inInventory] positioned ^ ^ ^10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"convUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[convSelect,selectUp],UUIDMost:15,UUIDLeast:1}
execute as 0-0-e-0-1 at @s[tag=!softExitConv,tag=!inInventory] positioned ^ ^ ^-10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"convDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[convSelect,selectDown],UUIDMost:15,UUIDLeast:2}
execute as 0-0-e-0-1 at @s[tag=!softExitConv,tag=!inInventory] positioned ^10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"convUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[convSelect,selectLeft],UUIDMost:15,UUIDLeast:3}
execute as 0-0-e-0-1 at @s[tag=!softExitConv,tag=!inInventory] positioned ^-10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"convDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[convSelect,selectRight],UUIDMost:15,UUIDLeast:4}
