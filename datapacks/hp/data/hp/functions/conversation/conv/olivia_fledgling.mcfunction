...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" В каждм матче используют два Бладжера, которые летают повсюду и пытаются врезаться в игроков, что бы выбить их с метлы.\\n\\n\\n\"}"}
execute if entity @s[tag=use] run tag @s add longHeader
