...
#-------------------------------
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=8}] run data merge entity @s {CustomName:"{\"text\":\"≥ Прощайте\"}",Tags:["_____Return_____","_____click_____","convOption","i"]}
