...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Have you gotten a look at Визжащая Хижина yet? It's meant to be the most haunted building in Britain. \\n\\n\\n\\n\"}"}
