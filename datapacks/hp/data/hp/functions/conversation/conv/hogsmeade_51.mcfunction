...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" I'm selling a few things I don't need to Дэрвиш и Бэнгз... Money is tight right now. \\n\\n\\n\\n\"}"}
