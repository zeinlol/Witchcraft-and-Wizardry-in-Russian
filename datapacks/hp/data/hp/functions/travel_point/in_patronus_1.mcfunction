...
execute as @s[scores={travelPoint=30}] at @s run tp @s 8032.30 80.72 74.94 336.94 -12
execute as @s[scores={travelPoint=30}] run tag @s add fog
execute as @s[scores={travelPoint=30}] run function hp:misc/update_bossbars
execute as @s[scores={travelPoint=29}] at @s run tp @s 8032.30 80.72 74.94 336.94 -11
...
execute as @s[scores={travelPoint=0}] run tag @s remove travelPointPatronus1