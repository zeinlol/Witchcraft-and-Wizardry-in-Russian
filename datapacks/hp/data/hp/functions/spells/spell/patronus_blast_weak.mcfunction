...
execute store result entity @s Motion[0] double -0.0125 run scoreboard players get @s tmp3
...
execute run scoreboard players operation @s tmp3 -= @s tmp4
execute store result entity @s Motion[1] double -0.0125 run scoreboard players get @s tmp3
...
execute run scoreboard players operation @s tmp3 -= @s tmp4
execute store result entity @s Motion[2] double -0.0125 run scoreboard players get @s tmp3
