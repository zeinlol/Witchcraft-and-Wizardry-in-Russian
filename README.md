# Witchcraft and Wizardry in Russian
  ...
  Перевод на русский язык последней официальной версии популярного мода для Майнкрафта "Witchcraft and Wizardry", окунающий игрока во вселенную Гарри Поттера. Этот мод ничего не добавляет и не удаляет из игры. При переводе учитывалась адаптация на русский язык всех имён и названий с оригинала. Для этого вся нужная информация бралась с фанатского сайта https://harrypotter.fandom.com/ru/wiki/ .На данный момент переведён интерфейс, название всех квестов, предметов, персонажей, локаций и практически все диалоги. 
...
# Установка русификатора  
  Для установки необходимо скопировать папку "hp" в папку оригинального мода, с заменной всех файлов. Ничего не удаляйте в ручную, могут возникнуть проблемы.
...
Подробная инструкция:
  ...
  5. Открыть папку распакованого архива и скопировать папку "hp";
  ...
  Эта инструкция так же есть в папке с этой модификацией под названием "Инструкция.txt"
  
  Так же хочу обратить внимаение, что разработчики рекомендуют использовать клиент optifine для игры.
