...
execute as @s[scores={timeSinceSpawn=0}] unless score @s spawnCount matches 0 unless score @s spawnCount matches 0 if score @s maxCreatureCount > @s creatureCount at @s run function hp:creatures/skeleton_swordsman/nest_summon_skeleton_swordsman
...
# Count each skeleton swordsman belonging to this nest.
