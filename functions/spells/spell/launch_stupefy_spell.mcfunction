...
### Stupefy spell ###
execute as @s[tag=!usingStrengthPotion] at @s run summon trident ^ ^ ^0.5 {damage:2d,Team:"NPC",NoGravity:1b,Color:-1,Tags:["spellEntity","stupefySpell","stupefy_ini"],Passengers:[{id:"minecraft:armor_stand",Team:"NPC",Invulnerable:1b,Small:1b,Invisible:1b,Marker:1b,Tags:["spellEntity","stupefyDirection","stupefyDirection_ini"]}]}
execute as @s[tag=usingStrengthPotion] at @s run summon trident ^ ^ ^0.5 {damage:2d,Team:"NPC",NoGravity:1b,Color:-1,Tags:["spellEntity","stupefySpell","stupefy_ini","strengthAmplified"],Passengers:[{id:"minecraft:armor_stand",Team:"NPC",Invulnerable:1b,Small:1b,Invisible:1b,Marker:1b,Tags:["spellEntity","stupefyDirection","stupefyDirection_ini"]}]}
