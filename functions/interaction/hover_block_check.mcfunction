...
execute unless block ~ ~ ~ #hp:hover_ray run tag @s remove hover
...
execute if score hoverRC tmp matches 1.. positioned ^ ^ ^.2 run function hp:interaction/hover_block_check
