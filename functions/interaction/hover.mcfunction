...
execute if entity @s[scores={pickUpTimer=0},tag=inWingardium,tag=hoveringOnWingardiumBox,tag=!isLiftingWingardiumBox,tag=!hoveringOnWingardiumBoxInSwitch,tag=play] store success score @s tmp run title @s actionbar ["",{"text":"Нажмите ","color":"dark_purple"},{"text":"⌡","bold":false,"color":"white"},{"text":" что бы поднять","color":"dark_purple"}]
execute if entity @s[scores={pickUpTimer=0},tag=inWingardium,tag=hoveringOnWingardiumBox,tag=isLiftingWingardiumBox,tag=play] store success score @s tmp run title @s actionbar ["",{"text":"Нажмите ","color":"dark_purple"},{"text":"⌡","bold":false,"color":"white"},{"text":" что бы поставить","color":"dark_purple"}]
execute if entity @s[scores={pickUpTimer=0},tag=inWingardium,tag=hoveringOnWingardiumBox,tag=!isLiftingWingardiumBox,tag=hoveringOnWingardiumBoxInSwitch,tag=play] store success score @s tmp run title @s actionbar ["",{"text":"Нажмите ","color":"dark_purple"},{"text":"⌡","bold":false,"color":"white"},{"text":" что бы поднять с кнопки","color":"dark_purple"}]
execute if entity @s[scores={pickUpTimer=0},tag=inWingardium,tag=isLiftingWingardiumBox,tag=hoveringWingardiumBoxOverSwitch,tag=play] store success score @s tmp run title @s actionbar ["",{"text":"Нажмите ","color":"dark_purple"},{"text":"⌡","bold":false,"color":"white"},{"text":" что бы поствить на кнопку","color":"dark_purple"}]
...
# Apparate
execute if entity @s[scores={pickUpTimer=0},tag=inAppiration,tag=cantApparateHere] store success score @s tmp run title @s actionbar ["",{"text":"Тут нельзя трансгрессировать","color":"red"}]

# Invisibility cape
execute if entity @s[scores={pickUpTimer=0,invisCapeAnim=..0},tag=!inWingardium,tag=!showMaraudersMap,tag=!inQuestBook,tag=!inSettings,tag=!showSpellSelection,tag=!inInventory,tag=!castAlohomora,tag=!inProperCutScene,tag=!inResetPoint,tag=!cutsceneOverrideActionbar,tag=invisCape,tag=play,tag=!usingInvisibilityPotion] store success score @s tmp run title @s actionbar ["",{"text":"Вы невидимы. Что бы снять Мантию-невидимку нажмите '"},{"keybind":"key.sneak"},"'."]
...
execute if entity @s[scores={pickUpTimer=0},tag=!inWingardium,tag=!showMaraudersMap,tag=!inQuestBook,tag=!inSettings,tag=!showSpellSelection,tag=!inInventory,tag=!castAlohomora,tag=!inProperCutScene,tag=!inResetPoint,tag=!cutsceneOverrideActionbar,tag=earmuffs,tag=!isHoveringOnMandrake,tag=play] store success score @s tmp run title @s actionbar ["",{"text":"Вы одели Спектрально-астральные очки. что бы их снять нажмите 'Shift'."}]

# Replant mandrake
execute if entity @s[scores={pickUpTimer=0},tag=!inWingardium,tag=!showMaraudersMap,tag=!inQuestBook,tag=!inSettings,tag=!showSpellSelection,tag=!inInventory,tag=!castAlohomora,tag=!inProperCutScene,tag=!inResetPoint,tag=!cutsceneOverrideActionbar,tag=earmuffs,tag=isHoveringOnMandrake,tag=play] store success score @s tmp run title @s actionbar ["",{"text":"Нажмите ","color":"gold"},{"text":"⌡","color":"white"},{"text":" что бы посадить Мандрагору. ","color":"gold"}]
