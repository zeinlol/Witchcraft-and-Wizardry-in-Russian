...
execute as @e[tag=gladragsWizardwearEntity] at @s run tp @s ~ -200 ~
kill @e[tag=gladragsWizardwearEntity]

kill @e[tag=chunkLoader]

scoreboard players set gladragsWizardWearIsCulled global 1