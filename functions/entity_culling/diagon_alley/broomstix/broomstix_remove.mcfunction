...
execute as @e[tag=chunkLoader,limit=1,sort=nearest] at @s run spreadplayers 2824 840 1 1 false @s
...
execute as @e[tag=broomstixEntity] at @s run tp @s ~ -200 ~
kill @e[tag=broomstixEntity]

kill @e[tag=chunkLoader]

scoreboard players set broomstixIsCulled global 1