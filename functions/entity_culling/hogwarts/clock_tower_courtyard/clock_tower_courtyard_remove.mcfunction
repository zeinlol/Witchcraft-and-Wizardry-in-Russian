...
execute as @e[tag=clockTowerCourtyardEntity] at @s run tp @s ~ -200 ~
kill @e[tag=clockTowerCourtyardEntity]

kill @e[tag=chunkLoader]

scoreboard players set clockTowerCourtyardIsCulled global 1