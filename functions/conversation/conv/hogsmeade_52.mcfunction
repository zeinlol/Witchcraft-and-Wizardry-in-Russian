...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Gladrag's Wizardwear is alright, but I prefer 'Твилфитт и Таттинг' in Косой Переулок. \\n\\n\\n\\n\"}"}
