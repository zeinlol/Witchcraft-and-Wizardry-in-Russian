...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Если бы Макгонагалл была так же хороша как Снейп, тогда у меня был бы шанс пройти С.О.В. \\n\\n\\n\\n\"}"}
