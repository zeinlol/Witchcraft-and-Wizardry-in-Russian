...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Ищешь гостинную Слизена? Или класс Зельеварения? Эти указатели очень полезны, да? \\n\\n\\n\\n\"}"}
