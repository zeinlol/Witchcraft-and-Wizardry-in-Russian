...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Hello dear. I'm Мадам Розмерта. Welcome to the Три Метлы. What can I get you? \"}"}
...
execute as @s[tag=use] as @e[type=armor_stand,limit=1,scores={con=3}] run data merge entity @s {CustomName:"{\"text\":\"≤ Tell me about the Три Метлы\"}",Tags:["_____Normal_____","_____click_____","convOption","i"]}
