...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"[{\"text\":\" Welcome to the Knight Bus! Emergency transport for the stranded witch or wizard. My name is \"},{\"text\":\"Стэнли Шанпайк\",\"color\":\"gold\",\"bold\":\"true\"},{\"text\":\" and I will be your conductor this evening.\\n\\n\\n\"}]"}
