...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Good day! Флореан Фортескью. Yes, that's right, like Dexter Fortescue. And this is my ice cream parlour. \"}"}
