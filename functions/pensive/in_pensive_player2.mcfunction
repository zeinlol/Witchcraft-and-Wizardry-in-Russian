...
# Scroll testers
execute as 0-0-11-0-2 at @s[tag=!softExitConv,tag=!inInventory] positioned ^ ^ ^10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"pensiveUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[pensiveSelect,selectUp],UUIDMost:18,UUIDLeast:5}
execute as 0-0-11-0-2 at @s[tag=!softExitConv,tag=!inInventory] positioned ^ ^ ^-10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"pensiveDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[pensiveSelect,selectDown],UUIDMost:18,UUIDLeast:6}
execute as 0-0-11-0-2 at @s[tag=!softExitConv,tag=!inInventory] positioned ^10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"pensiveUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[pensiveSelect,selectLeft],UUIDMost:18,UUIDLeast:7}
execute as 0-0-11-0-2 at @s[tag=!softExitConv,tag=!inInventory] positioned ^-10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"pensiveDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[pensiveSelect,selectRight],UUIDMost:18,UUIDLeast:8}
