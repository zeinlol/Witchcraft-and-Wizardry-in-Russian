...
execute as @s[scores={playerID=1}] run kill 0-0-11-0-1
execute as @s[scores={playerID=2}] run kill 0-0-11-0-2
execute as @s[scores={playerID=3}] run kill 0-0-11-0-3
execute as @s[scores={playerID=4}] run kill 0-0-11-0-4
...
tag @s remove inPensive
tag @s remove exitPensive