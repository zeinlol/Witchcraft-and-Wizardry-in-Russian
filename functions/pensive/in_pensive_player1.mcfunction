...
# Scroll testers
execute as 0-0-11-0-1 at @s[tag=!softExitConv,tag=!inInventory] positioned ^ ^ ^10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"pensiveUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[pensiveSelect,selectUp],UUIDMost:18,UUIDLeast:1}
execute as 0-0-11-0-1 at @s[tag=!softExitConv,tag=!inInventory] positioned ^ ^ ^-10 run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"pensiveDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[pensiveSelect,selectDown],UUIDMost:18,UUIDLeast:2}
execute as 0-0-11-0-1 at @s[tag=!softExitConv,tag=!inInventory] positioned ^10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"pensiveUp\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[pensiveSelect,selectLeft],UUIDMost:18,UUIDLeast:3}
execute as 0-0-11-0-1 at @s[tag=!softExitConv,tag=!inInventory] positioned ^-10 ^ ^ run summon area_effect_cloud ~ ~ ~ {CustomName:"{\"text\":\"pensiveDown\"}",Radius:0.0f,Duration:0,Particle:"block air",Tags:[pensiveSelect,selectRight],UUIDMost:18,UUIDLeast:4}
