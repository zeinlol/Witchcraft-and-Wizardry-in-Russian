...
execute as @s[scores={animTest=7,tmp2=1}] store result entity @s ArmorItems[3].tag.Damage int 1 run scoreboard players set @s animState 1462
...
execute unless score @s animState matches 1447.. run scoreboard players set @s animState 1461
execute as @s[scores={animState=..1446}] run scoreboard players set @s animState 1461
execute as @s[scores={tmp2=0,tmp4=1}] store result entity @s ArmorItems[3].tag.Damage int 1 run scoreboard players remove @s animState 1
scoreboard players set @s[scores={tmp4=2..}] tmp4 0
