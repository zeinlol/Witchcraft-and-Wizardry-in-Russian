...
##### Conversation Header ######
################################
execute if entity @s[tag=use] as 0-0-6-0-9 run data merge entity @s {CustomName:"{\"text\":\" Подожди, что это такое? Я занял поле для Квиддича для того, чтобы Гриффиндор мог потренироваться. \\n\\n\\n\\n\"}"}
